...
from hubmap_entity import HubmapEntity, AsyncHubmapEntity, APIResponseValidationError
from hubmap_entity._types import Omit
from hubmap_entity._models import BaseModel, FinalRequestOptions
from hubmap_entity._constants import RAW_RESPONSE_HEADER
from hubmap_entity._exceptions import APIStatusError, APITimeoutError, APIResponseValidationError
from hubmap_entity._base_client import (
    DEFAULT_TIMEOUT,
...
def _get_open_connections(client: HubmapEntity | AsyncHubmapEntity) -> int:
...
class TestHubmapEntity:
            ...
            for frame in diff.traceback:
                if any(
                    ...
                    for fragment in [
                        ...
                        "hubmap_entity/_legacy_response.py",
                        "hubmap_entity/_response.py",
                        # pydantic.BaseModel.model_dump || pydantic.BaseModel.dict leak memory for some reason.
                        "hubmap_entity/_compat.py",
    ...
    def test_multipart_repeating_array(self, client: HubmapEntity) -> None:
        request = client._build_request(
    ...
    def test_base_url_trailing_slash(self, client: HubmapEntity) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_base_url_no_trailing_slash(self, client: HubmapEntity) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_absolute_request_url(self, client: HubmapEntity) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
    ...
    @mock.patch("hubmap_entity._base_client.BaseClient._calculate_retry_timeout", _low_retry_timeout)
    @pytest.mark.respx(base_url=base_url)
    ...
    def test_omit_retry_count_header(
        self, client: HubmapEntity, failures_before_success: int, respx_mock: MockRouter
    ) -> None:
        client = client.with_options(max_retries=4)
...
class TestAsyncHubmapEntity:
    ...
    def test_multipart_repeating_array(self, async_client: AsyncHubmapEntity) -> None:
    ...
    def test_base_url_trailing_slash(self, client: AsyncHubmapEntity) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_base_url_no_trailing_slash(self, client: AsyncHubmapEntity) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_absolute_request_url(self, client: AsyncHubmapEntity) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="https://myapi.com/foo",
    ...
    async def test_retries_taken(
        self,
        async_client: AsyncHubmapEntity,
        failures_before_success: int,
        failure_mode: Literal["status", "exception"],
        respx_mock: MockRouter,
    ) -> None:
    ...
    async def test_omit_retry_count_header(
        self, async_client: AsyncHubmapEntity, failures_before_success: int, respx_mock: MockRouter
    ) -> None:
        client = async_client.with_options(max_retries=4)
    ...
    def test_get_platform(self) -> None:
        ...
        from hubmap_entity._utils import asyncify
        from hubmap_entity._base_client import get_platform 
